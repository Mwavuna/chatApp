...
npx gh-pages -d frontend/dist -r https://github.com/Mwavuna/chatApp.git #push the dist folder in the frontend directory to the gh-pages branch of the repository
